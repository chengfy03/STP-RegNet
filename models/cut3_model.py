...
class CUT3Model(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--nce_layers', type=str, default='0,1,4,8,11', help='compute NCE loss on which layers')
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['real_A', 'fake_B', 'register_fake_B', 'real_B', 'register_real_A', 'train_B']
        ...
        # stn
        self.netR = networks.define_stn(opt.input_nc,self.gpu_ids)
    ...
    def forward(self):
        ...
        # 变形场由fake_B预测得到
        self.register_fake_B, self.register_real_A, self.grid = self.netR(self.fake_B.detach(), self.real_A)
    ...
    def compute_R_loss(self):
        ...
        self.loss_R = self.cosine(center_crop_224(self.register_fake_B)[0, 0], center_crop_224(self.real_B)[0, 0],
                                  self.target)
        return self.loss_R
